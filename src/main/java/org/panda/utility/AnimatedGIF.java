...
class AnimatedGif {
	...
	/**
	 * Ozgun's addition to Andrew's class.
	 *
	 * @param pngFiles array of PNG filenames
	 * @param outGIF name of output animated GIF file
	 * @param delay the delay between frames in one hundredth of a second. 100 equals to one second.
	 * @throws Exception
	 */
	public static void generate(String[] pngFiles, String outGIF, int delay) throws Exception
	{
		...
		saveAnimate(new File(outGIF), frames, delays);
	}
}
